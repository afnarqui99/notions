/**
 * Servicio para gestionar notas generales
 */
...
class GeneralNoteService {
  ...
  async getAllNotes() {
    try {
      // Listar todos los archivos en data y filtrar los de general-notes
      ...
      const notes = await Promise.all(
        generalNoteFiles.map(async (file) => {
          try {
            ...
            // Verificar que sea una nota general válida
...
export default new GeneralNoteService();
